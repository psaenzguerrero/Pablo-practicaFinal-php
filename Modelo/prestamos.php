<?php
    ...
    class Prestamo {
        ...
        public function obtenerPrestamos(int $id_usuario) {
            $sentencia ="SELECT amigos.nombre, juegos.titulo, juegos.foto, fecha_prestamo, devuelto, id_prestamo FROM amigos, juegos, prestamos WHERE prestamos.id_amigo=amigos.id_amigo AND prestamos.id_juego=juegos.id_juego AND prestamos.id_usuario=?;";
            ...
            while($consulta->fetch()){
                array_push($prestamos, [$res, $res2, $res3, $res4, $res5, $res6]);
            };
            $consulta->close();
            return $prestamos;
        }
